...
- (void)viewDidLayoutSubviews {
    ...
    self.enterButton.center     = (CGPoint){self.view.width * 0.5f ,self.view.height * 0.75f};
    self.enterButton.bounds     = (CGRect) {CGPointZero ,self.enterButton.currentImage.size};
}
